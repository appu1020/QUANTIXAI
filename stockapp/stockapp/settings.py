...
DEBUG = _config("DEBUG", default="False", cast=lambda v: str(v).lower() in ("true", "1", "yes"))
ALLOWED_HOSTS = _config("ALLOWED_HOSTS", default="quantixai.onrender.com,localhost,127.0.0.1").split(",")
CSRF_TRUSTED_ORIGINS = _config("CSRF_TRUSTED_ORIGINS", default="https://quantixai.onrender.com").split(",")
